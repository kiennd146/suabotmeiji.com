...
{else}
	...
	<div class="block_various_links" id="block_various_links_footer">
		...
		<div class="block">
		<h4 class="title_block">{l s='Service & Support' mod='blockcms'}</h4>
		<a class="show_hide_footer" href="javascript:void(0)">icon</a>
		<ul class="f_block_content">
			...
			<li class="item"><a href="{$link->getPageLink('manufacturer')}" title="{l s='By brand' mod='blockcms'}">{l s='By brand' mod='blockcms'}</a></li>
		</ul>
		</div>
	{$footer_text}
	</div>
