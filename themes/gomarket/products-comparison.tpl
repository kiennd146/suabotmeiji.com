...
<div style="width: {sizeof($products)*235+225}px;" class="content_comapre">
	<table id="product_comparison">
	<tr>
			<td style="width:225px" class="td_empty"></td>
		...
		{foreach from=$products item=product name=for_products}
			...
			<td style="width:235px" class="ajax_block_product comparison_infos">
				...
				<h3><a href="{$product->getLink()}" title="{$product->name|escape:'htmlall':'UTF-8'}">{$product->name|truncate:40:'...'|escape:'htmlall':'UTF-8'}</a></h3></div>
				<div class="product_desc">{$product->description_short|strip_tags|truncate:100:'...'}</div>			
